    ...
    for jjj = 1:j_max
        ...
        if yes == 1
           drs = 0;
            ...
            drs = .5;                    % drs drag reduction percent (0-1)
    end
